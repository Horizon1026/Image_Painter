...
std::array<std::array<uint8_t, 12>, 95> AssicFonts::ascii_1206_ = {{
...
std::array<std::array<uint8_t, 16>, 95> AssicFonts::ascii_1608_ = {{
...
std::array<std::array<uint8_t, 36>, 95> AssicFonts::ascii_2412_ = {{
